...
3. Use the `search_jobs` tool to find remote, foreign, and Gilgit-based jobs that match their AI Engineering profile. Make several targeted searches (e.g., "AI Engineer remote jobs", "Machine learning jobs Gilgit", etc.).
